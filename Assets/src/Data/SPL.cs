...
namespace Data
{
    ...
    public class SPL : Rules
    {
        public SPL()
        {
            ...
            robotsPlaying = 5;
            /* The C# Colors the left and the right team starts with. */
            teamColor = new Color[] { Color.Blue, Color.Red, Color.Yellow, Color.Black, Color.White, Color.Green, Color.Orange, Color.Purple, Color.Brown, Color.Gray };
            ...
            allowedHardwarePenaltiesPerHalf = int.MaxValue;
            /* Number of hardware penalties per game before the robot is ejected. */
            allowedHardwarePenaltiesPerGame = int.MaxValue;
